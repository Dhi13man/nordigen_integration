...
Future<void> main() async {
  group('Nordigen Transaction Models Unit Tests', () {
    test('Parse sample Transaction Data', () {
      ...
      // Act - Parse Data
      final TransactionData transactionData = TransactionData.fromMap(
        sampleTransactionMap,
      );
    ...
    test('Parse List of sample Transaction Data', () {
      ...
      sampleTransactionMapList = <Map<String, dynamic>>[
        <String, dynamic>{
          'transactionId': 'uuid',
          'endToEndId': 'PNR17989245,KNR351239',
          'bookingDate': '2022-08-15',
      ...
      for (Map<String, dynamic> transactionMap in sampleTransactionMapList) {
        ...
        expect(
          transactionData.transactionAmount.currency,
          transactionMap['transactionAmount']['currency'],
        );
        expect(
          transactionData.currencyExchange?.length ?? 0,
