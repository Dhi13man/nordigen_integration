...
void agreementsTests({
  ...
  test(
    ...
    () async {
      ...
      // TEST creation
      final EndUserAgreementModel endUserAgreementModel = await nordigenObject
  ...
  /// TEST 3.2
  test('GET all Agreements with limit: [getEndUserAgreements]', () async {
    const int limit = 2;
    // TEST creation
  ...
  /// TEST 3.3
  test('GET and DELETE a End-User Agreement by ID: [getEndUserAgreementUsingID]'
      ' and [deleteEndUserAgreementUsingID]', () async {
    final EndUserAgreementModel endUserAgreement = await nordigenObject
        .createEndUserAgreement(institutionID: testInstitutionID);
    // GET the created Agreement and compare.
    final EndUserAgreementModel fetchedEndUserAgreement = await nordigenObject
        .getEndUserAgreementUsingID(endUserAgreementID: endUserAgreement.id);
    // Integrity check
