...
void step6Tests({
  ...
  /// TEST 6.1
  test('Access account meta data: [getAccountMetaData]', () async {
    // GET accountsIDs
  ...
  /// TEST 6.2
  test('Access account details: [getAccountDetails]', () async {
    // GET accountsIDs
    final List<String> accountsIDs = await nordigenObject.getEndUserAccountIDs(
      requisitionID: requisitionIDWithAccountAccess,
    );
  ...
  /// TEST 6.3
  test('Access account balances: [getAccountBalances]', () async {
    // GET accountsIDs
    final List<String> accountsIDs = await nordigenObject.getEndUserAccountIDs(
      requisitionID: requisitionIDWithAccountAccess,
    );
  ...
  /// TEST 6.4
  test('Access account transactions: [getAccountTransactions]', () async {
    // GET accountsIDs
    final List<String> accountsIDs = await nordigenObject.getEndUserAccountIDs(
      requisitionID: requisitionIDWithAccountAccess,
    );
