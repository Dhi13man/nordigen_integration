...
Future<void> main() async {
  ...
  final Institution firstBank = (await apiInterface.getInstitutionsForCountry(
    countryCode: 'gb',
  )).first;

  /// Step 3
  final EndUserAgreementModel endUserAgreementModel = await apiInterface
  ...
  /// Step 4
  final RequisitionModel requisition = await apiInterface
